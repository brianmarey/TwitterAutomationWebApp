...
@Controller
public class AnchorTextsController {
	private static final Logger LOGGER = LoggerFactory.getLogger(AnchorTextsController.class);
    ...
    @RequestMapping(value="/anchorTexts", method=RequestMethod.GET)
